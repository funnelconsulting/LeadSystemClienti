      ...
      const mailOptions = {
        ...
        html: `
          <html>
            <body>
              <p>Gentile ${nome},</p>
              <p>Ti diamo il benvenuto nel tuo LeadSystem! Di seguito trovi le tue informazioni di accesso:</p>
              <p>Email: ${email}</p>
              <p>Password: 12345678</p>
              <a href="${url}" style="display: inline-block; padding: 10px 20px; background-color: #3471CC; color: #fff; text-decoration: none; border-radius: 5px;">Accedi e cambia password</a>
